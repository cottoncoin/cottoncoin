Contributing to Cotton Core
============================

The Cotton Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Cotton Core project, and is not to be
confused with overall Cotton Network Protocol consensus changes.

Whether a pull request is merged into Cotton Core rests with the project merge
...
Patches that change Cotton consensus rules are considerably more involved than
...
Where a patch set proposes to change the Cotton consensus, it must have been
...
The project leader is the release manager for each Cotton Core release.
