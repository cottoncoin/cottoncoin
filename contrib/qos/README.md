...
This means one can have an always-on cottond instance running, and another local cottond/cotton-qt instance which connects to this node and receives blocks from it.
