...
RESOURCES += src/qt/cotton.qrc src/qt/cotton_locale.qrc

TRANSLATIONS += src/qt/locale/cotton_bg.ts \
                src/qt/locale/cotton_de.ts \
                src/qt/locale/cotton_en.ts \
                src/qt/locale/cotton_es.ts \
                src/qt/locale/cotton_fi.ts \
                src/qt/locale/cotton_fr.ts \
                src/qt/locale/cotton_it.ts \
                src/qt/locale/cotton_ja.ts \
                src/qt/locale/cotton_pl.ts \
                src/qt/locale/cotton_pt.ts \
                src/qt/locale/cotton_ru.ts \
                src/qt/locale/cotton_sk.ts \
                src/qt/locale/cotton_sv.ts \
                src/qt/locale/cotton_vi.ts \
                src/qt/locale/cotton_zh_CN.ts \
                src/qt/locale/cotton_zh_TW.ts
