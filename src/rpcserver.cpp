...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Cotton features */
        {"cotton", "masternode", &masternode, true, true, false},
        {"cotton", "listmasternodes", &listmasternodes, true, true, false},
        {"cotton", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cotton", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cotton", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cotton", "masternodedebug", &masternodedebug, true, true, false},
        {"cotton", "startmasternode", &startmasternode, true, true, false},
        {"cotton", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cotton", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cotton", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cotton", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cotton", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cotton", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cotton", "mnbudget", &mnbudget, true, true, false},
        {"cotton", "preparebudget", &preparebudget, true, true, false},
        {"cotton", "submitbudget", &submitbudget, true, true, false},
        {"cotton", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cotton", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cotton", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cotton", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cotton", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cotton", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cotton", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cotton", "checkbudgets", &checkbudgets, true, true, false},
        {"cotton", "mnsync", &mnsync, true, true, false},
        {"cotton", "spork", &spork, true, true, false},
        {"cotton", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"cotton", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cottond, or the -server option to cotton-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> cotton-cli " + methodname + " " + args + "\n";
}
