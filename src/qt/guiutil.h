...
/** Utility functions used by the Cotton Qt UI.
 */
namespace GUIUtil
{
...
// Render Cotton addresses in monospace font
...
// Parse "cotton:" URI into recipient object, return true on successful parsing
