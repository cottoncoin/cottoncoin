                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Cotton Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Cotton address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cotton: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zCOTN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Cotton Core"), this);
    aboutAction->setStatusTip(tr("Show information about Cotton Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Cotton"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Cotton addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Cotton addresses"));
    ...
    openAction->setStatusTip(tr("Open a Cotton: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Cotton Core help message to get a list with possible Cotton command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Cotton Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Cotton network", "", count));
}
...
{
    QString strTitle = tr("Cotton Core"); // default title
...
/** Creates context menu, its actions, and cottons up all the relevant signals for mouse events. */
