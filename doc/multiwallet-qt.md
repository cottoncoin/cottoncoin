...
In order to support loading of multiple wallets in cotton-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cotton.cpp.
...
Changes to cotton.cpp
----------------------
cotton.cpp is the entry point into cotton-qt, and as such, will require some minor modifications to provide hooks for
